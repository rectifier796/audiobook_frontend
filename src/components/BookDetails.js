  ...
  return (
    <div className="p-4">
      <div className="container mx-auto">
        <div className="block md:grid md:grid-cols-2 md:gap-4">
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <p className="mb-4 text-gray-600">
                <span>{audioBook.averageRating}</span> (Based on {audioBook.numOfReviews} reviews)
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Reviews section */}
        <div className="mt-8">
          <h2 className="text-2xl text-center font-semibold mb-4">User Reviews</h2>
          {reviews.map((review, index) => (
            <div key={index} className="p-4 mb-4 border border-gray-300 rounded-lg shadow-sm">
              <p>
